...
export default function ComingSoonBadge() {
  return (
    <div className="flex flex-col items-center gap-3">
      <div className="flex items-center gap-3 rounded-2xl border border-cream/10 bg-cream/[0.055] p-2 shadow-[0_20px_60px_-36px_rgba(0,0,0,0.95)] backdrop-blur-md">
        {/* Greyed "coming soon" App Store badge */}
        <div
          className="flex items-center gap-3 rounded-xl border border-cream/15 bg-ink/65 px-4 py-2.5 text-left"
          role="img"
        ...
        >
          ...
          <div className="leading-tight">
            <div className="text-[10px] uppercase tracking-wide text-cream/60">Coming soon to the</div>
            <div className="text-lg font-semibold text-cream">App&nbsp;Store</div>
          </div>
        </div>
